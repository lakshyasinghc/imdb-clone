...
import {HomeIcon,UserIcon,PhoneIcon,InformationCircleIcon } from '@heroicons/react/outline'
...
export default function Header() {
  return (
    ...
    <Image src="https://upload.wikimedia.org/wikipedia/commons/6/69/IMDB_Logo_2016.svg"
        width={100}
        height={100}
        className="cursor-pointer hover:brightness-110  active:brightness-125"
    />
    </div>
  )
}
